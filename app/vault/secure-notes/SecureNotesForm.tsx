...
interface SecureNotesFormProps {
  id: string
  handleReload: () => void
  handleDrawerCloseClicked: () => void
}

const SecureNotesForm = ({ id, handleReload, handleDrawerCloseClicked }: SecureNotesFormProps): React.ReactNode => {
      ...
      if (id !== '') {
        ...
        if (result !== null) {
          ...
          if (decryptedData !== undefined) {
            ...
            setNotes(decryptedDataObj.secret)
          }
        }
      } else {
  ...
  return (
    <div className='mx-8 mt-6'>
      <h1 className='my-3 text-lg font-medium'>Secure Note Details</h1>
      {
        isLoading
          ? (
